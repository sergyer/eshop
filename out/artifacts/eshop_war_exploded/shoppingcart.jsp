...
<body>
  ...
  <ul class="main-menu">
    <li class="main-menu-item active"><a href="home.jsp">Home</a></li>
  ...
  <div>
    <br><h1 align="center">Shoping Cart</h1>
  </div>
  <c:choose>
    <c:when test="${cart==null || cart.size==0 }">
     <br><br><br><h3 align="center">Your cart is empty :(</h3>
    </c:when>
  </c:choose>
...
<br>
 <c:choose>
  ...
  <div align="center" >
    <table  class="table1" >
      ...
      <c:forEach var="lineitem" items="${cart.lineItems}" >
          <td class="name1">${lineitem.product.name}</td>
          <td class="descrip" >${lineitem.product.description}<br></td>
          <td class="name1">${lineitem.product.price}</td>
          <td class="name1">
            <form action="UpdateCart" method="post">
              <input type="hidden" name="code"
                     value="<c:out value='${lineitem.product.code}'/>">
              <input type="number" min="1" max="20" name="quantity" class="quantity_box"
                      value="<c:out value='${lineitem.quantity}'/>" >
              &nbsp;
    ...
    <table class="total">
      <tr>
        ...
        <td align="center">Total Price <br> ${cart.amount} <br> <form action="checkout.jsp" method="post" >
  ...
  <footer id="footer">
    ...
    <div id="footer-inner">
      <p>&copy; Copyright Sergey Yeranosyan  &#124; <a href="#">Terms of Use</a> &#124; <a href="#">Privacy Policy</a></p>
      <div class="clr"></div>
    </div>
  </footer>
</body>
